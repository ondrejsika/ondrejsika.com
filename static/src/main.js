...
for(i = 0; i< links.length; i++){
    ...
    if (links[i].hostname != "localhost" && links[i].hostname != "ondrejsika.com" && links[i].hostname != "www.ondrejsika.com" && links[i].hostname != "personal.ondrejsika.com") links[i].target = "_blank"
}
